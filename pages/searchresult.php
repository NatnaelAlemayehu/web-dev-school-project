...
if (isset($_SESSION['accountId'])) {
    ...
    $_POST['propertyType'] = $_GET['propertyType'];
    $_POST['propertyStatus'] = $_GET['propertyStatus'];
} else {
    session_destroy();
    // if ($_GET['price']) {
        ...
        <div id="content">
                ...
                <div class="container-fluid"><button type="button" id="sidebarCollapse" class="btn btn-info"><i
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <?php
                            if (isset($_SESSION['accountId'])) {
                                echo '<li class="nav-item"><a class="nav-link" href="property_registration.php">Register Property</a></li>
            ...
            <div class="row px-3 py-5">
                ...
                if (isset($_POST['searchButton'])) {
                    $allsearch = new Search_query($_POST);
                    $allsearch->search();
