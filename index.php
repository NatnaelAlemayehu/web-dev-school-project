...
if (isset($_POST['landingSearch'])) {
    ...
    header("Location: ./pages/searchresult.php?propertyStatus=$propertyStatus&propertyType=$type&location=$location");
}
?>
<!doctype html>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    if (isset($_SESSION['accountId'])) {
                        echo '<li class="nav-item"><a class="nav-link" href="./pages/signout.php">Sign Out</a></li>';
                    } else {
                        echo '<li class="nav-item"><a class="nav-link" href="./pages/signin.php">Sign In</a></li>
            ...
            <div class="row how-it-works">
                <div class="col-lg-4 col-md-6">
                    <div class="pl-3 pr-3 mb-4 bg-white shadow-one rounded">
                        ...
                        <h5 class="text-secondary py-2 mt-3 mb-2">Search / List Your Home</h5>
                        <p>
                            Search for your perfect home. Wheather it is for sale or rent you will find what you are
                            looking for.If you have a property to sale or rentour platform is the best place for you to
                            showcase your property. Sign in and register your property Now.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="pl-3 pr-3 mb-4 bg-white shadow-one rounded">
                        <i class="falticon-home flat-medium text-primary" aria-hidden="true"></i>
                        <h5 class="text-secondary py-2 mt-3 mb-2">Make a visit request/h5>
                            <p>
                                Before you buy or start renting the property. You need to be able to visit the property
                                and see if it
                                meets your need. And we will give you a free ride to where your property is located.
                                Only if you are
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="pl-3 pr-3 mb-4 bg-white shadow-one rounded">
                        <i class="falticon-home flat-medium text-primary" aria-hidden="true"></i>
                        <h5 class="text-secondary py-2 mt-3 mb-2">Take ownership of your property</h5>
                        <p> Once you decide you want to take ownership of the property you visited.Then you sign legal
                            contracts with us and the property owner and take ownership.
                        </p>
                    </div>
                </div>
            </div>
